...
export function IconCloud({
  ...
  useEffect(() => {
    ...
    for (let i = 0; i < numIcons; i++) {
      ...
      newIcons.push({
        x: x * distanceBetweenImage,
        y: y * distanceBetweenImage,
        z: z * distanceBetweenImage,
        scale: 1,
        opacity: 1,
        id: i,
      });
  ...
  useEffect(() => {
    ...
    const animate = () => {
      ...
      iconPositions.forEach((icon, index) => {
        ...
        const scale = (rotatedZ + 900) / 1000;
        const opacity = Math.max(0.5, Math.min(1, (rotatedZ + 150) / 200));
