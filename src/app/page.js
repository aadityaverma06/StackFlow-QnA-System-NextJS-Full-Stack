...
export default function Home() {
  ...
  return (
    <div className="flex flex-col min-h-screen p-5 xs:p-10 font-[family-name:var(--font-geist-sans)] justify-center items-center gap-8">
      <main className="flex flex-col gap-[32px] row-start-2 items-center max-w-sm">
        <div className="flex flex-col gap-[32px] row-start-2 items-center justify-center sm:mb-10 pl-4">
          <h1 className="text-4xl font-extrabold text-gray-900 dark:text-white md:text-5xl lg:text-6xl text-left">
        ...
        <ol className="list-outside list-disc text-base/6 text-left font-[family-name:var(--font-geist-mono)] pl-6 space-y-6">
        ...
        {user ? (
          <div className="flex gap-4 items-center flex-col sm:flex-row sm:justify-between sm:w-full">
            ...
            <Link
              className="rounded-full border border-solid border-transparent transition-colors flex items-center justify-center text-white bg-gradient-to-r bg-clip-padding from-[#6c17b7] to-[#4a00e0] gap-2 hover:bg-gradient-to-r hover:from-[#8d2de2ba] hover:to-[#4b00e0b2] font-medium text-sm sm:text-base h-10 sm:h-12 px-4 sm:px-5 sm:w-auto w-full"
              href="/logout"
            >
              <IconLogout2 size={20} />
              Logout
